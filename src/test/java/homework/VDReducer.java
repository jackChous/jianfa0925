...
public class VDReducer implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJarByClass(VDReducer.class);
        job.setMapperClass(VDMapper.class);
    ...
    public static void main(String[] args) {
        try {
            int resultCode = ToolRunner.run(new VDReducer(), args);
            if (resultCode == 0) {
