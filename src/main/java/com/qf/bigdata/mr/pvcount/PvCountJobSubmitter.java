...
public class PvCountJobSubmitter {
    public static void main(String[] args) throws Exception {
        ...
        //通过类名获取jar包位置
        job.setJarByClass(PvCountJobSubmitter.class);
         ...
         * 设置数据的读取位置
         */
        FileInputFormat.setInputPaths(job,new Path("opt/app/hadoop-2.7.7/log"));
         ...
         * 定义写出的位置
         */
        FileOutputFormat.setOutputPath(job,new Path("opt/app/hadoop-2.7.7/out"));
